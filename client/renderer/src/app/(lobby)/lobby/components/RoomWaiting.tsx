...
import LeaguePage from "@renderer/src/components/LeaguePage";
import sessionService from '@renderer/src/services/session';
import LeagueNav from "@renderer/src/components/LeagueNav";
...
export default function ({ roomName, time, seats, onJoin, onKick, onStartGame, onQuit, onAutoArrange }: Props) {
  ...
  return <LeaguePage title={roomName} inNavPage showButton
